            ...
            <div class="max-w-[420px] min-w-[320px] bg-white rounded-b-3xl mx-auto">
                ...
                <div class="px-10 pt-4 pb-8 rounded-3xl shadow-xl">
                    <div class="mx-auto text-center">
                        <h1 class="text-4xl text-gray-800">Sign Up</h1>
                    </div>
                    <form action="" method="POST">
                        ...
                        <div class="mt-10 relative">
                            <input id="name" type="name" name="name"
                                ...
                                placeholder="Name" />
                            <label for="name"
                                class="absolute left-0 -top-3.5 text-gray-600 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-purple-600 peer-focus:text-sm">Name
                            </label>
                        </div>
                        <div class="mt-10 relative">
