...
<div style="background-image: url('https://images.unsplash.com/photo-1605184861733-be9f5814095e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=995&q=80')" class="relative min-h-screen bg-purple-100 backdrop-blur flex justify-center items-center bg-texture bg-cover py-28 sm:py-0">
      ...
      <div class="max-w-[420px] min-w-[320px] bg-white rounded-b-3xl mx-auto">
        ...
        <div class="px-10 pt-4 pb-8 rounded-3xl shadow-xl">
          ...
          <form action="" method="POST">
            <div class="relative">
              <input id="email" name="email" type="text" class="peer w-full px-0.5 border-0 border-b-2 border-gray-300 placeholder-transparent outline-none py-1" placeholder="">
            ...
            <div class="mt-10 relative">
              <input id="password" type="password" name="password" class="peer w-full px-0.5 border-0 border-b-2 border-gray-300 placeholder-transparent outline-none py-1" placeholder="Password" />
